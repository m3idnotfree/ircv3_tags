...
//! # DEPRECATED
//!
//! **⚠️ This crate has been deprecated and is no longer maintained. Use
//! [ircv3_parse](https://docs.rs/ircv3_parse) instead**
//!
#![deprecated(
    since = "3.0.0",
    note = "This crate is deprecated. Use `ircv3_parse` instead."
)]
